...
class UI:
    def __init__(self):
        self.optiontable = [
            ...
            option("--step", action="store", help="Export only up to this step."),
            option("--no-rpms", action="store_true", help="Do not export RPMs."),
            option(
                "--no-packages",
                action="store_true",
            ...
            option(
                "--no-errata", action="store_true", help="Do not export errata data."
            ),
            option(
                "--no-kickstarts",
                action="store_true",
            ...
            option("--all-orgs", action="store_true", help="Export all orgs."),
            option(
                "-o",
                "--org",
                action="append",
